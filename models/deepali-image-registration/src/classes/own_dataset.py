...
class OwnDataset(Dataset):
    def __init__(self, data, seg_data=None, transform=None):
        """
        Custom dataset class for loading CT scans with segmentations.
    ...
    def __getitem__(self, idx):
        ...
        if self.seg_data is not None:
            ...
            fixed_seg_resampled = fixed_img.resample_from_to(fixed_seg_nii)
            moving_seg_resampled = moving_img.resample_from_to(moving_seg_nii)
