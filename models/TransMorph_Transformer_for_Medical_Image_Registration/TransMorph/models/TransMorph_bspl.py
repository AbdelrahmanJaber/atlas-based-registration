...
class TranMorphBSplineNet(nn.Module):
    ...
    def forward(self, inputs):
        src, tar = inputs
        # print(f"[TransMorph.forward] src shape: {src.shape}, tar shape: {tar.shape}")
        ...
        # print("[TransMorph.forward] final src shape:", src.shape)
        # print("[TransMorph.forward] final tar shape:", tar.shape)
        # print("[TransMorph.forward] final disp shape:", disp.shape, flush = True)
