...
def dice_val(y_pred, y_true, num_clus):
    ...
    # y_true_clipped = y_true.clone()
    # y_true_clipped = torch.clamp(y_true_clipped, 0, num_clus - 1)   
...
def process_label():
    ...
    file1 = open('/vol/miltank/users/fratzke/Documents/atlas-based-registration/models/TransMorph_Transformer_for_Medical_Image_Registration/TransMorph/label_info.txt', 'r')
